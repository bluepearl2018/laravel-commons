...
@section('content')
	<h1 class="text-4xl">{{__('Laravel Commons Configuration')}}</h1>
	<p class="mb-2 italic">{{__('Package info')}}</p>
		<div class="table w-full">
			@forelse(config('eutranet-commons.models') as $model)
				<div class="flex flex-row align-top align-text-top mb-4 border-b-2 justify-between">
					<div class="lg:table-cell">
						...
						@if(class_exists('Eutranet\\Commons\\Models\\'.$model))
							@php $class = 'Eutranet\\Commons\\Models\\'.$model @endphp
